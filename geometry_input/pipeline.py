...
def process_input_geometry(file_path: str,
    ...
    if geom_type == 'mixed':
        logger.warning("Mixed geometry types detected - will attempt to process")
        # For mixed geometries, we'll try to extract the most useful type
    ...
    # Also check actual geometry type after dissolve (handles mixed geometries)
