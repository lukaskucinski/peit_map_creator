            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-col gap-4 w-full max-w-md">
                ...
                {mapUrl && (
                  <div className="flex items-center justify-center gap-2 text-sm">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={copyMapUrl}
                      className="gap-1 h-8 hover:bg-accent hover:scale-[1.02] active:scale-[0.98] transition-all duration-150"
                    >
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="gap-2 mx-auto hover:bg-accent hover:scale-[1.02] active:scale-[0.98] transition-all duration-150"
                  disabled={isDownloading}
                >
                  <RotateCcw className="h-4 w-4" />
